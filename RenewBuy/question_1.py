...
# generating a list of tuples from the string
lst = [tuple(each_entry.split(',')) for each_entry in string.split()]

# sorting the list using sorted function
# specified order of sort by mentioning key in the sorted method
